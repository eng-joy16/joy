...
<head>
    ...
    <script>
        function toggleFormFields() {
            ...
            if (serviceType === "Car Cleaning") {
                carTypeField.style.display = "none";
                locationField.style.display = "block";
                dateField.style.display = "block";
                note.style.display = "block";
                submitBtn.style.display = "block";
            } else if (serviceType === "Vehicle Maintenance") {
...
<div class="container">
    ...
    <form action="confirm_service.php" method="POST">
        <select name="service_name" id="serviceType" onchange="toggleFormFields()" required>
